...
`easyBot` is a security-focused local AI assistant for the terminal. It can chat, read and edit files inside approved directories, work across codebases and local projects, search project content, and run guarded local commands without going through a shell.
